...
const LOGIN_URL = 'https://chat.dezygn.com/auth';
    ...
    <header className="fixed left-1/2 top-4 z-50 w-[calc(100%-2rem)] max-w-4xl -translate-x-1/2">
      <div className="flex h-14 items-center justify-between rounded-full border border-[#E8E4DB]/15 bg-[#1A1A1A]/[0.92] pl-2 pr-2 shadow-[0_16px_44px_rgba(0,0,0,0.35)] backdrop-blur-md">
        ...
        <nav className="hidden items-center gap-4 md:flex">
          ...
          <a href={LOGIN_URL} className="text-sm font-semibold text-[#E8E4DB]/80 transition hover:text-[#E8E4DB]">
            Login
          </a>
          <a
            href={SIGNUP_URL}
      ...
      {open ? (
        <div className="mt-2 rounded-2xl border border-[#E8E4DB]/15 bg-[#1A1A1A]/95 p-3 shadow-[0_16px_44px_rgba(0,0,0,0.35)] backdrop-blur-md md:hidden">
          <div className="grid gap-2">
            ...
            <a href={LOGIN_URL} className="rounded-xl px-3 py-2.5 text-sm font-medium text-[#E8E4DB]/85" onClick={() => setOpen(false)}>
              Login
            </a>
