...
export const glossaryEntries: GlossaryEntry[] = [
  ...
  },
  {
    slug: "packshot",
    term: "Packshot",
    metaTitle: "What is a Packshot? — AI Photography Glossary | Dezygn",
    metaDescription:
      "Learn what a packshot is, why marketplaces require it, and how AI packshot generation keeps products accurate, consistent, and compliant.",
    definition:
      "A packshot is a clean, isolated photograph of a product — typically on a white or neutral background with even, controlled lighting and no environmental context. It is the documentation shot of commercial photography: Amazon requires it as the main listing image, catalogs are built on it, and every product page uses it as the customer's reference for what will actually arrive.",
    explanation: [
      "The packshot's job is accuracy, not seduction. With no scene to carry mood, every detail of the product is exposed: shape, materials, finish, label text, proportions. That makes it the purest accuracy test in AI photography — there is nowhere for an embellished render to hide, and a packshot that flatters the product into dishonesty produces 'item not as pictured' returns.",
      "Professionally, packshots are produced from a locked recipe — consistent lens (around 85mm), deep aperture for front-to-back sharpness, high-key lighting, and a natural contact shadow that grounds the product — applied identically across an entire product line. Consistency across SKUs is what separates a catalog from a collection of photos.",
    ],
    howItRelates:
      "In Dezygn, packshots are generated by anchoring to the real product photo — the AI recreates the product rather than guessing at it — with the studio recipe configured once and batched across the line. Source-resolution rules keep label text legible, and the same validated product asset is then reused for lifestyle, hero, and detail shots.",
    relatedTerms: ["white-background", "studio-photography", "pdp"],
  },
  {
    slug: "pdp",
    term: "PDP (Product Detail Page)",
    metaTitle: "What is a PDP? — AI Photography Glossary | Dezygn",
    metaDescription:
      "What a product detail page (PDP) is, what its image set needs to accomplish, and why PDP imagery is the natural entry point for AI photography work.",
    definition:
      "A PDP — product detail page — is the page where a single product is presented and purchased: the images, title, price, description, and reviews for one item. In e-commerce imagery, 'PDP images' refers to the set of 5-7 photographs that page needs to convert: a compliant packshot, lifestyle context, scale reference, detail close-ups, and packaging.",
    explanation: [
      "The PDP image set is a system of answers. The packshot answers 'what exactly is it?', the lifestyle shot answers 'what does it look like in my life?', the scale shot answers 'how big is it really?', and the macro detail answers 'is it well made?'. Listings that answer all four questions convert; listings that repeat one answer five times leak sales to the unanswered questions.",
      "For agencies and freelancers, PDP imagery is also the standard entry point into a client relationship: it is the most clearly scoped, most obviously needed work. Once PDP images are live and performing, the natural account-growth path runs PDP → ad creative → ongoing social content — each step more recurring than the last.",
    ],
    howItRelates:
      "Dezygn batches complete PDP sets per product from one validated source asset: locked packshot recipe, brand-world lifestyle scenes, hands-as-reference scale shots, and macro details. For agencies, the PDP package is the foot in the door that the platform's workflow then grows into retainer work.",
    relatedTerms: ["packshot", "hero-shot", "conversion-rate"],
  },
  {
    slug: "comp-card",
    term: "Comp Card",
    metaTitle: "What is a Comp Card? — AI Photography Glossary | Dezygn",
    metaDescription:
      "What a comp card is in AI model workflows: a selection grid of poses and angles — and why it must never be used as a compositing source.",
    definition:
      "A comp card (composite card) is a grid of images showing one model in different poses, angles, and expressions — borrowed from the modeling industry, where agencies use them to present talent. In AI photography, comp cards are generated per candidate model so a client or art director can select the right face for a campaign.",
    explanation: [
      "The comp card solves the casting problem: instead of judging a model from a single render, you evaluate consistency and range across a grid — does the face hold across angles, does the energy match the brand?",
      "The critical professional rule: the comp card is for selection only. It should never be used as a source image for compositing, because it contains too much competing visual information, and the source image wins over the prompt. In one documented client project, a comp card showing sunglasses pushed above the model's eyebrows contaminated every subsequent composite — the AI kept placing glasses above the brows, exactly like the source. The fix was a clean portrait: white background, neutral clothing, no accessories. Hours lost; lesson permanent.",
    ],
    howItRelates:
      "Dezygn's model workflow runs brief → comp cards → clean portraits → composite: the model brief is written from the brand identity, comp cards handle selection, and clean portraits become the prepped ingredient every future composite is built from.",
    relatedTerms: ["dedicated-model", "visual-syntax", "creative-direction"],
  },
  {
    slug: "dedicated-model",
    term: "Dedicated Model",
    metaTitle: "What is a Dedicated Model? — AI Photography Glossary | Dezygn",
    metaDescription:
      "What a dedicated AI model is: one consistent, brand-matched face used across an entire campaign or catalog — and why consistency converts.",
    definition:
      "A dedicated model is a consistent, AI-generated person — one recognizable face, matched to a brand's actual customer — used across an entire campaign, catalog, or content calendar. It is the AI equivalent of a brand signing a face for the season, without the booking fees.",
    explanation: [
      "Model inconsistency is one of the fastest amateur tells in AI imagery: a storefront where every product is worn by a different randomly generated person reads as exactly what it is. A dedicated model gives a brand the recognition asset that beauty and fashion houses pay heavily to maintain — the same face on the PDP, in the ads, and across social.",
      "Casting is deliberate: the model brief is written from the brand identity, specifying the customer's actual demographics and the brand's energy — 'age 35-60, elegant, understated, calm presence, never demonstrative' for a minimal luxury brand reads completely differently than the 'never poses for pictures, owns the world' direction of an attitude-led campaign. The subject IS the customer avatar.",
    ],
    howItRelates:
      "In Dezygn, dedicated models are cast via comp cards, maintained via clean portraits, and composited with real product photos — so the same brand-matched face carries months of content while the products stay accurate.",
    relatedTerms: ["comp-card", "brand-consistency", "visual-syntax"],
  },
  {
    slug: "brand-world",
    term: "Brand World",
    metaTitle: "What is a Brand World? — AI Photography Glossary | Dezygn",
    metaDescription:
      "What a brand world is in AI photography: the researched visual universe — geography, materials, light, palette — that a brand's imagery lives inside.",
    definition:
      "A brand world is the researched visual universe a brand's imagery lives inside: its geography, materials, light, color palette, and cultural references, documented and applied to every image. It is the difference between prompting 'aesthetic background' and knowing exactly which world this brand belongs to.",
    explanation: [
      "Brand worlds are built through deep moodboarding — beyond collecting reference images into researching competitors' visual standards, the product's materials, and the brand's story and geography. A documented example: for a premium Japanese titanium eyewear brand, research traced the craft to Sabae, Japan — the eyewear capital of the world — and found Ono Castle, 'the castle in the sky,' whose lightness matched the brand's lightweight-luxury promise. Those discoveries became the scene library.",
      "The commercial logic: customers who buy into a world pay world prices; customers comparing isolated products pay commodity prices. And practically, a researched world produces imagery competitors cannot accidentally copy — 'Mediterranean coastal, olive groves, sun-bleached linen, terracotta and sage' generates a recognizably different catalog than any generic preset.",
    ],
    howItRelates:
      "Dezygn operationalizes brand worlds: the brand identity is extracted and locked (palette, temperature, scene presets, model direction), research images become source material for scene generation, and every image in the catalog gets staged inside the same documented universe.",
    relatedTerms: ["mood-board", "brand-consistency", "visual-syntax"],
  },
  {
    slug: "proof-before-pitch",
    term: "Proof Before Pitch",
    metaTitle: "What is Proof Before Pitch? — AI Photography Glossary | Dezygn",
    metaDescription:
      "The Proof Before Pitch outreach mechanism: send a prospect one finished, custom AI visual of their own product — before asking for anything.",
    definition:
      "Proof Before Pitch is a client-acquisition mechanism where, instead of emailing a prospect to ask for a meeting, you email them a finished deliverable: one custom, AI-generated lifestyle image of their own product, made in their brand's style, attached, free, with no ask beyond 'would this be useful?'",
    explanation: [
      "The mechanism inverts cold outreach psychology. Traditional cold email asks for trust first and promises value later; Proof Before Pitch delivers value first, so gratitude replaces resistance. The claim every freelancer makes in words — 'I can improve your visuals' — is proven in pixels before the conversation starts. The image does the selling.",
      "It runs on volume governed by the Rule of 100: judge no outreach channel before 100 serious attempts. Realistic math from 100 proof emails: 5-8 responses, 2-3 calls, roughly one closed deal — normal B2B cold-outreach numbers, and enough, because documented first deals from this mechanism include $2,000 and $4,800 projects and monthly retainers in the $700-800 range.",
    ],
    howItRelates:
      "Each proof image is a compressed R&D pass — brand extraction, clean product source, one excellent on-brand shot — which Dezygn produces in about half an hour per prospect, and the platform's Outreach Factory runs the mechanism as a batch pipeline. The full training is at dezygn.com/webinar.",
    relatedTerms: ["pdp", "creative-fatigue", "brand-world"],
  },
  {
    slug: "creative-fatigue",
    term: "Creative Fatigue",
    metaTitle: "What is Creative Fatigue? — AI Photography Glossary | Dezygn",
    metaDescription:
      "What creative fatigue is, why Meta's ranking changes made it worse, and why constant creative refresh is now a structural need for ad-driven brands.",
    definition:
      "Creative fatigue is the performance decay an ad creative suffers as the same audience sees it repeatedly: click-through rates fall, costs rise, and the campaign degrades — not because the product or targeting changed, but because the image wore out.",
    explanation: [
      "Fatigue has always existed, but modern ad platforms accelerated it structurally. Meta's ranking systems increasingly reward fresh creative variety over single optimized winners — brands now need multiple variations per campaign, refreshed continuously, rather than one hero image run for a quarter.",
      "That collides with traditional production economics: a studio shoot takes weeks and serious budget, while an active ad account consumes creative weekly. The gap between production speed and consumption speed is the structural opening that AI photography services fill — and why ad-running brands are the most qualified prospects for them.",
    ],
    howItRelates:
      "Dezygn produces ad variation volume from validated assets: the same accurate product across fresh scenes, models, and formats — lifestyle, UGC-style, comparison frames — at the weekly cadence fatigue demands. For agencies, fatigue is also the recurring-revenue engine: ad creative is never 'done.'",
    relatedTerms: ["ugc", "conversion-rate", "proof-before-pitch"],
  },
  {
    slug: "multimodal-anchoring",
    term: "Multimodal Anchoring",
    metaTitle: "What is Multimodal Anchoring? — AI Photography Glossary | Dezygn",
    metaDescription:
      "Multimodal anchoring in AI photography: communicating each visual ingredient with words, images, or both — words describe, images define.",
    definition:
    ...
    relatedTerms: ["visual-syntax", "prompt-engineering", "background-removal"],
  },
  {
    slug: "sequential-pipeline",
    term: "Sequential Pipeline",
    metaTitle: "What is a Sequential Pipeline? — AI Photography Glossary | Dezygn",
    metaDescription:
      "The sequential pipeline in AI photography: building complex images from validated intermediate assets instead of one-shot prompting.",
    definition:
      "A sequential pipeline is the professional method of building complex AI images in steps — scenes, models, and products generated and validated as separate assets, then composited — instead of attempting the finished image in a single prompt. Complex images are built sequentially, not in one shot.",
    explanation: [
      "One-shot prompting forces the AI to solve for person, product, pose, environment, and lighting simultaneously, producing compromises on every element. The sequential pipeline isolates each variable: scenes generated empty in multiple angles with matching light, models as clean portraits, products as prepped 2K sources — each validated before it's used.",
      "The payoff is debuggability. When a composite fails, you know which ingredient failed, fix that one asset, and recompose — instead of re-rolling the entire lottery. Errors get caught early instead of compounding, and validated assets become a reusable library that makes every subsequent campaign faster.",
    ],
    howItRelates:
      "Dezygn's Director Mode automates the sequential pipeline — decompose, validate, composite — while the asset libraries (scenes, models, products) persist per brand, which is how a first campaign that takes a day becomes a monthly session that takes two hours.",
    relatedTerms: ["multimodal-anchoring", "visual-syntax", "batch-processing"],
  },
];
