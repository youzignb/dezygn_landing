...
/** Standard white card. */
export const card = 'rounded-3xl border border-[#1A1A1A]/[0.12] bg-white p-8 shadow-[0_24px_60px_rgba(26,26,26,0.08)]';

/** Interactive card (links). */
export const cardLink = 'group rounded-3xl border border-[#1A1A1A]/[0.12] bg-white shadow-[0_24px_60px_rgba(26,26,26,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_32px_70px_rgba(26,26,26,0.14)]';
