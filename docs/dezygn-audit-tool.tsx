...
import { Globe, Zap, Check, AlertCircle, ArrowRight, Sparkles, TrendingUp, Palette, Users, Image, Video, ChevronRight, Eye, Download, Share2, RefreshCw, BarChart3, Target, Layers, Star, Loader2, ExternalLink } from 'lucide-react';

function DezignAudit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // In production, this will call your Supabase edge function
      ...
      const mockResponse = {
        ...
        "industry": "Hair & Grooming Services",
        "target_audience": "Adult men, likely 20-55, seeking haircuts, beard trims, and grooming in a professional, local setting",
        "name": "Coiffure UOMO Barbershop Web Visual Audit",
        "primary_color": "#65cbc8",
        "secondary_color": "#fa5f71",
        "background_color": "#ffffff",
        "font_style": "Rounded sans-serif, bold for headings, standard for body text",
        "brand_personality": "Modern, Approachable, Masculine",
        "core_values": "Professionalism, Speed, Expertise, Customer focus",
        "key_visual_elements": "Portrait hero image, turquoise accent blocks, rounded buttons, service icons, authentic in-salon photography",
        "quickWin1_title": "Enrich service demonstration visuals",
        "quickWin1_current": "Only a few small images of haircutting process; majority of page is text about services.",
        "quickWin1_opportunity": "Generate more varied, contextual images of staff at work, different hair/beard styles, and the shop environment.",
        "quickWin1_impact": "high",
        "quickWin1_feature": "VisualDNA™ - Generate alternative in-salon scenes",
        "quickWin2_title": "Add video social proof and service walkthrough",
        "quickWin2_current": "No client testimonials, no video content, static points forts list.",
        "quickWin2_opportunity": "Create video testimonials of satisfied clients, and/or short video clips of typical service workflows.",
        "quickWin2_impact": "high",
        "quickWin2_feature": "MotionSpark™ - Turn static scenarios into social-friendly video",
        "quickWin3_title": "Modernize static testimonial and offer sections",
        "quickWin3_current": "All service benefits and USPs are in simple red-highlighted text blocks.",
        "quickWin3_opportunity": "Re-design these using icons, imagery, interactive or dynamic visuals for stronger engagement.",
        "quickWin3_impact": "medium",
        "quickWin3_feature": "ReDesign One™ - Instantly uplift highlight and testimonial sections",
        "colorConsistency": 90,
        "visualStyleScore": 78,
        "imageQualityScore": 81,
        "brandIssue1": "Hero image is sharply professional; in-salon photos are lower-res and stylistically inconsistent.",
        "brandIssue2": "Visual points forts list lacks graphical support—just text with colored bars.",
        "brandIssue3": "The turquoise accent background is used for blocks but not tied to a wider visual language (lack of pattern or repeated motif).",
        "competitiveGap1": "Competitors often show more staff personality—team in action or welcoming clients.",
        "competitiveGap2": "Industry standard includes video service previews or before/after transformations.",
        "competitiveGap3": "Opportunity to showcase seasonal offers or grooming tips in blog/Instagram formats.",
        "contentMultiplication1": "Service demo photos → Multiple hairstyle/beard variations, different client profiles",
        "contentMultiplication2": "Text USPs → Icon-based infographics, video explainers",
        "contentMultiplication3": "Static testimonials → Video or animated testimonial reels",
